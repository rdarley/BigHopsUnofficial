...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { Untapped_Beer_id: @beer.Untapped_Beer_id, abv: @beer.abv, brewery: @beer.brewery, name: @beer.name, price: @beer.price, style: @beer.style }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { Untapped_Beer_id: @beer.Untapped_Beer_id, abv: @beer.abv, brewery: @beer.brewery, name: @beer.name, price: @beer.price, style: @beer.style }
    assert_redirected_to beer_path(assigns(:beer))
  end
